...
In the 'Billag.zig' file you will find all the MATLAB scripts and the videops analysed for this project. To run any of the MATLAB Scripts, rename the file-paths to yours.
